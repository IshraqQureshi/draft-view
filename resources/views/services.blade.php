...
@section('content')
    ...
    <section id="page--header">
        <div class="container">
            <div class="page--header-heading">
                <h1>Draft View <span class="highlight">Services</span></h1>
            </div>
        </div>
    </section>

    <section id="options-section" class="page-option-section">
        <div class="container">
    ...
    <section id="calculate-section" class="section page-calculate-section">
        <div class="container">
